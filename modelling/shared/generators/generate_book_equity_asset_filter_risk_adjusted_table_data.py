...
for path in [SCRIPT_DIR, SHARED_DIR, PROJECT_ROOT]:
...
def print_identification(
    ...
    print("  weighting helper: modelling/shared/generators/generate_capped_weight_risk_adjusted_table_data.py::load_ucits_weight_monthly_returns")
