...
DATA_DIR_PROF = BASE_DIR / "PROF" / "prof_components_extracted"
DATA_DIR_ACC = BASE_DIR / "PROF" / "acc_components_extracted"
...
def load_panel_prof(min_year: int = 2005, max_year: int = 2024) -> pd.DataFrame:
    return load_panel(DATA_DIR_PROF, min_year, max_year)


def load_panel_acc(min_year: int = 2005, max_year: int = 2024) -> pd.DataFrame:
    return load_panel(DATA_DIR_ACC, min_year, max_year)
